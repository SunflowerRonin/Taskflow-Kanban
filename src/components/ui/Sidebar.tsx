        ...
        {links.map(link => {
          ...
          return (
            <a
              ...
              style={{
                backgroundColor: isActive ? '#1e1e30' : 'transparent',
                color: isActive ? '#e2e2f0' : '#9999b3',
              }}
              onMouseEnter={e => {
              ...
              onMouseLeave={e => {
                e.currentTarget.style.backgroundColor = isActive ? '#1e1e30' : 'transparent'
                e.currentTarget.style.color = isActive ? '#e2e2f0' : '#9999b3'
              }}
            >
              {link.icon}
